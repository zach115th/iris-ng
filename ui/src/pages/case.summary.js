...
/* Expose functions invoked from inline HTML on* handlers (onclick=, ...) so the
 * Vite 8 / rolldown bundler does not tree-shake them: they have no in-module
 * caller, and this file must stay in ui/src/pages/ because it imports crc32, so
 * the ui/public/ escape hatch used for other case-page JS is unavailable here.
 * See CLAUDE.md "Vite 8 + rolldown silently drops globally-exported function
 * declarations". Without this, the Generate-report button is dead
 * (report_template_selector opens the modal; gen_report/gen_act_report fire it). */
Object.assign(window, {
    report_template_selector,
    act_report_template_selector,
    gen_report,
    gen_act_report,
    edit_case_summary,
    sync_editor,

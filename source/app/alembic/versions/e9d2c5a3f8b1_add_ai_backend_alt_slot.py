...
defined (e.g. LM Studio + Claude proxy) and switch the active one from the
...
def upgrade():
    ...
    if not _table_has_column('server_settings', 'ai_backend_active_slot'):
        op.add_column(
            'server_settings',

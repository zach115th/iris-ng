...
def _ensure_asset(
    *,
    ...
    # iris-ng v2 (Phase 4): registry sync — bypasses the funnel, so call it
    # here too. Runs on its OWN engine connection (this path is
    # mid-transaction; sync must never commit the promote's half-done work)
    # and never raises.

...
class SectorForm(FlaskForm):
    slug = StringField(u'Sector slug (stable key)', validators=[DataRequired()])
    name = StringField(u'Sector display name', validators=[DataRequired()])
    tag = StringField(u'MISP machine-tag', validators=[DataRequired()])

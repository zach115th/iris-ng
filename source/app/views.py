...
from app.blueprints.pages.alert_clusters.alert_clusters_routes import alert_clusters_page_blueprint
from app.blueprints.pages.correlation.correlation_routes import correlation_page_blueprint
...
from app.blueprints.pages.manage.manage_sectors_routes import manage_sectors_blueprint
...
from app.blueprints.pages.manage.manage_metrics_inventory_routes import manage_metrics_inventory_blueprint
from app.blueprints.pages.manage.manage_settings_pages_routes import manage_settings_pages_blueprint
...
from app.blueprints.pages.manage.manage_teams_routes import manage_teams_blueprint
...
from app.blueprints.rest.manage.manage_sectors_routes import manage_sectors_rest_blueprint
...
def register_blusprints(app):
    ...
    app.register_blueprint(manage_metrics_inventory_blueprint)
    ...
    app.register_blueprint(manage_sectors_blueprint)
    app.register_blueprint(manage_sectors_rest_blueprint)
    ...
    app.register_blueprint(alert_clusters_page_blueprint)
    app.register_blueprint(correlation_page_blueprint)

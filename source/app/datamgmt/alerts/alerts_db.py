...
def create_case_from_alerts(alerts: List[Alert], iocs_list: List[str], assets_list: List[str], case_title: str,
    ...
    # iris-ng fix (2026-09-01): upstream never initialized this, so escalating
    # WITHOUT a case template raised NameError at the f-string below (the
    # single-alert create_case_from_alert has the init; this batch variant
    # lacked it).
    ...
    # iris-ng fix (2026-09-01): ''.split(',') is [''] — an untagged escalate
    # used to mint an EMPTY Tags row per case. Same guard idiom as
    # merge_alert_in_case below.

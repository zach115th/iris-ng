...
def _details_case(cur_id: int, caseid: int, url_redir: bool) -> Union[str, Response]:
    ...
    # iris-next: time-tracking summary for the Time tab + Total time field.
    from app.datamgmt.case.case_time_db import case_time_summary
    time_summary = case_time_summary(cur_id)
    ...
    return render_template("modal_case_info_from_case.html", data=res, form=form, protagonists=protagonists,
                           ...
                           severities=severities, time_summary=time_summary)

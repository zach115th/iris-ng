...
def case_review(caseid):
    ...
    # Phase 5: a review REQUEST notifies the reviewer - post-commit,
    # fail-soft by contract. keep_actor: self-assigned reviews DO notify
    # (maintainer decision - a standing assignment is worth a record even
    # when you gave it to yourself).
    if action == 'request' and case.reviewer_id:
        ...
        notify('case_review_requested', [case.reviewer_id],
               ...
               object_type='case', object_id=case.case_id, case_id=case.case_id,

...
def apply_campaign_tag():
    ...
    # Honour ACL — only apply to cases the user can see. Unconditional:
    # an EMPTY access list means the user can touch NOTHING (`if accessible`
    # skipped the filter for zero-access users, letting them tag any case —
    # same empty-list sentinel leak fixed in _accessible_case_ids).

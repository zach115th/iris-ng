...
is not already mentioned in the [roadmap](https://github.com/users/zach115th/projects/4/views/1). If an issue is similar 
...
## Others 
If you have any ideas not directly link to the code itself, you can directly contact us by [email](mailto:yes@iamzach.net). 
